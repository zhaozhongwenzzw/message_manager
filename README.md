...
| **命令面板 & 快捷键** | `Ctrl/Cmd+K` 唤出命令面板，常用动作一键直达（切 Tab、设置、回收站、外观、刷新、聚焦搜索 …）；输入 2+ 字符直接搜会话并回车打开；全局快捷键 `Ctrl+1/2 Ctrl+, Ctrl+F Ctrl+B Ctrl+S ?` |
...
![Command Palette & Shortcuts](docs/assets/command-palette-shortcuts-comic.png)
...
- [命令面板 & 快捷键](docs/specs/2026-05-28-command-palette-design.md)
